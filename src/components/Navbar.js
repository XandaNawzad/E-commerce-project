          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 pt-3 pb-2">
            <div className="relative flex items-center justify-between h-16">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-sky-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                ...
                <div className="flex-shrink-0 flex items-center">           
                  <img
                   className="hidden lg:block h-10 w-auto"
                    src="https://file.removal.ai/preview/tmp-6312db2fbc6bf.png"
                    alt="icons" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                  <img
                    className="hidden lg:block h-10 w-auto"
                      ...
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          isActive
                            ...
                            : 'text-gray-300 hover:bg-sky-500 hover:text-white px-3 py-2 rounded-md text-sm font-medium'
                        }
            ...
            <div className="px-2 pt-3 pb-2  space-y-1">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? 'block px-3 py-2 rounded-md text-base font-medium "bg-indigo-600  text-white  hover:bg-sky-500'
